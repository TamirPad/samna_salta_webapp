...
const mockSelectLanguage = require('../features/language/languageSlice').selectLanguage;
...
describe('HomePage', () => {
  ...
  describe('Features section', () => {
    ...
    it('should render feature descriptions', () => {
      ...
      expect(screen.getByText(/All our breads are baked fresh daily/)).toBeInTheDocument();
      expect(screen.getByText(/We use traditional recipes passed down/)).toBeInTheDocument();
      expect(screen.getByText(/Fast and reliable delivery throughout the city/)).toBeInTheDocument();
    });
    ...
    it('should have proper ARIA labels for feature cards', () => {
      ...
      const freshBreadCard = screen.getByText('Fresh Bread').closest('[role="button"]');
      expect(freshBreadCard).toHaveAttribute('aria-label', 'Learn more about Fresh Bread');
    });
  });
  ...
  describe('Products section', () => {
    ...
    it('should render product descriptions', () => {
      ...
      expect(screen.getByText(/Traditional Yemenite bread with unique flavor/)).toBeInTheDocument();
      expect(screen.getByText(/Traditional clarified butter/)).toBeInTheDocument();
      expect(screen.getByText(/Traditional Yemenite spice/)).toBeInTheDocument();
    });
    ...
    it('should have proper ARIA labels for product cards', () => {
      ...
      const kubanehCard = screen.getByText('Kubaneh').closest('[role="button"]');
